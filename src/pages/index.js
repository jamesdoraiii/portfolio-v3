    ...
    <Layout>
      ...
      <div className="container">
        ...
        <Project
          ...
          overview={`This was one of the more interesting projects I have had the privilege of working on during my time as a developer as well as one of my strongest learning experiences. While working at Pearcircuit we were tasked with creating an application that could handle all of the goings-on at Purdue Polytechnic Highschool. This included students scheduling their optional classes each week, setting up QR readers for students to scan in and out of school, allow teachers to take attendance, allow administrators to create classes, and much more. We were responsible for creating a web application that would run the entire school and all the development work fell on me and one other junior developer. While completing this project I learned many new technologies most notably, GraphQL, which I absolutely fell in love with. This project was my first time experiencing a true period of crunch. We had a little over a month to complete this project with all of the core functionality in place so that PPHS could begin school on time. In addition to this, we had to deal with changing requirements from our client right up until the final week. In the end, the project was completed on time with full functionality and I was very proud of my work. Unfortunately, since this is a privately owned application I am unable to share source code or an example of the working site.`}
          roles={[
        ...
        <Project
          ...
          overview={`Beat Share is a fully functional social media website focused on the sharing and discussion of electronic music. Beat Share is the first project I have developed using React as well as the first project I have worked on that utilizes a Node backend. Developing this website helped me understand the power of React, specifically its modularity. Many of the pages on Beat Share are composed using the same base components. This helped me develop knowledge of efficient code reuse and make the development of this project very streamlined. Utilizing Node was also very exciting for me because it allowed me to create a very interactive website with a high level of functionality.`}
        ...
        <Project
          ...
          overview={`This game is a personal project I developed using the PokeAPI. It selects a random pokemon from the API and uses a CSS filter to display a silhouette of said Pokemon. The player then has an opportunity to guess what the Pokemon is before the Pokemon is revealed and the player is told whether they are right or wrong. This game was meant to imitate the game which would appear on the Pokemon television show. This is the first website I ever developed which utilized complex javascript as well as interacting with an API.`}
          roles={["Sole Developer", "Sole Designer"]}
          original=""
        />
      </div>
